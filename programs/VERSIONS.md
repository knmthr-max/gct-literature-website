...
| JIF Reference Cleaner | `1.0.0` | `literature_pipeline/jif_reference_cleaner.py` | Convert licensed JCR CSV exports into one deduplicated, non-overwriting internal TSV per JIF data year. |
